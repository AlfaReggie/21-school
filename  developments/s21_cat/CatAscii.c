...
void CatAsciiTable(const char *table[static 256]) {
    ...
    memcpy(table, table_all, sizeof table_all);

}



void CatNumber_e(const char *table[static 256]) {
    table['\n'] = "$\n";

}

void CatNumber_t(const char *table[static 256]) {
    table['\t'] = "^I";

}


void CatNumber_v(const char *table[static 256]) {
    const char *arr_1[] = {"^@", "^A", "^B", "^C", "^D", "^E", "^F", "^G", "^H"};
    const char *arr_2[] = {
        "^K", "^L", "^M", "^N", "^O", "^P", "^Q", "^R", "^S",
        "^T", "^U", "^V", "^W", "^X", "^Y", "^Z", "^[", "^\\", "^]",
        "^^", "^_"
    ...
    memcpy(table, arr_1, sizeof arr_1);
    memcpy(&table[9 + 2], arr_2, sizeof arr_2);
    memcpy(&table['~' + 1], arr_3, sizeof arr_3);
